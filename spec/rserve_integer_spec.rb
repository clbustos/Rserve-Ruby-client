...
describe Rserve::REXP::Integer do
  describe "initialization" do
    ...
    it {should be_is_numeric}
    it {should be_is_integer}
    ...
    it "method is_NA should return coherent answer" do
      ...
      a=Rserve::REXP::Integer.new(payload)
      a.is_na?(a.as_integers[0]).should be_false
      a.is_na?(a.as_integers[2]).should be_true
      a.is_na?.should==[false,false,true,false,false]
    end
